...
**Meta assumida pelo dono (23 Set):** otimista-realista com criativos **30% melhores** que os de teste, ou seja **ROAS médio 2,83× de Out a Jan** (€45,8k de faturação, €16,2k de ads, ~€16,5k de lucro depois de ads). Parecer: ambicioso mas possível. 9–23 Set já deu 2,87× (a semana 2 foi melhor que a 1), mas a €48/dia; manter ~2,8× com uma média de ~€130/dia e CPMs de Q4 mais caros é o desafio. Faixa realista: 2,2–3,0×. Mesmo a ~2,2× o plano dá lucro (~€7,5k). Prova a meio de outubro: custo por encomenda **≤ €14 a €80–100/dia** = ritmo de −30% (e aí a regra manda ir full gas).
...
**"Plano realista" = o plano oficial (dono, 24 Set). É com este que se fazem as contas:** criativos 30% melhores que os de teste; budget/dia Out €80 → pré-BF €120 → Black Week €300 → Natal €200 → pós-Natal €100 → Saldos €100. Dá €36,7k até 31 Dez, **€45,6k Out–Jan, €16,2k de ads, €16,5k de lucro depois de ads**, 1.017 encomendas e ROAS 2,82×. É o cenário por defeito no simulador (`/plano-q4`) e no quadro "Real vs Plano" do `/dashboard`.
**Ponto de lucro máximo (modelo, criativos −30%):** cada fase maximiza o lucro quando o custo médio por encomenda chega a ~65% da margem por encomenda, ou seja ~€20–22 (é o ponto em que a encomenda *marginal* custa o mesmo que a margem). Budgets ótimos: Out ~€285, pré-BF ~€215, BW ~€610, Natal ~€385, pós-Natal ~€135, Saldos ~€240. Dá ~€77k de faturação e ~€36k de ads, mas só **~€19,3k de lucro (+€2,9k que o plano realista)**, com o ROAS a descer para 2,15×. A curva é muito plana no topo: ×1,5 o budget dá €18,2k e ×2 dá €18,9k. **Parecer:** o plano realista consegue ~85% do lucro máximo com menos de metade dos ads, e por isso tem menos risco (a elasticidade de 0,35 é uma extrapolação a partir de €48/dia), menos stock e menos caixa empatada. Subir para perto do ótimo só se a meio de outubro, a €80–100/dia, o custo por encomenda ficar claramente abaixo de €14. Regra prática para escalar: **continuar a subir o budget enquanto o custo médio por encomenda da fase ficar abaixo de ~€20.**
**Chegada da encomenda principal (dono, 24 Set): 1 Dez** (não 10 Nov). O plano na app passou a usar 1 Dez por defeito. Isto quer dizer que a Black Week (20 Nov – 1 Dez) corre só com o stock atual. No full gas (criativos −30%), sem oferta, esgotam antes de 1 Dez e ficam por vender até lá: Grip Preto Kids (~9 Out, ~184 un.), Azul Kids (~15 Out, ~153), Preto Adulto (~10 Nov, ~90), Branco Kids (~22 Nov, ~187), Vermelho Kids (~28 Nov, ~8), Built-In M (~19 Nov, ~217), Mini 8x5 Preto (~2 Nov, ~28), Tape Branco (~13 Out, ~47) e bubble mailers (~19 Out, ~770). As sleeves vêm à parte por avião (~19 Out) e por isso não contam para esta data.
**Stock segue o cenário da aba Plano (decisão do dono, 24 Set):** foi retirado o seletor "Encomendar para" (que por defeito usava full gas com criativos −30%). O inventário e a lista de compras usam sempre o cenário e os criativos escolhidos na aba Plano. Com chegada a 1 Dez: otimista-realista ≈ 913 encomendas até 31 Jan e ~2.850 un. a encomendar (~€2,9k); conservador ≈ 639 e ~1.800 un. (~€1,7k); full gas (criativos −20%) ≈ 1.470 e ~5.470 un. (~€6k). Isto substitui a regra de 23 Set de dimensionar sempre para o full gas: para ver a versão "não falta produto", escolhe Full gas na aba Plano.
**Plano na app (24 Set):** o simulador também está em `/plano-q4` na app (menu "Plano Q4"). Aí o stock, as vendas do site desde 9 Set, o nº de encomendas e as vendas a clubes vêm da base de dados em cada visita. Os pressupostos (cenários, custos, previsões por clube, prazos, mailers) continuam editáveis na página. O artifact do claude.ai fica como fotografia de 23 Set. Correção: o artifact contava o consumo de 53 encomendas (incluía 4 PENDING por pagar e uma de 6 Set) mas dividia por 46, por isso inflacionava o consumo por encomenda em ~10%. A app só conta encomendas pagas. Corrigido a 24 Set: o sync já só desconta stock de encomendas pagas; as 4 PENDING (#1295, #1300, #1304, #1307) devolveram 10 unidades (Branco Adulto +9, Preto Kids +6, Verde Kids +3, Built-In S +2, Tape +1).
...
**Sock Sleeves (decisão a 23 Set):** encomendar já (24 Set), à parte, por avião, porque não têm produção personalizada. Regra do dono: **no mínimo 25 de cada variante**, mesmo nas que ainda não venderam (Verde, Vermelho e Amarelo Kids, Amarelo Adulto). As que vendem bem são dimensionadas para o full gas **com margem extra**. As que ainda não venderam vão para **~50** (e não só 25), porque as vendas vão subir e os ads mostram todas as cores. Encomenda final proposta: **~1.125 un., ~€990 com avião**. O plano assume um consumo mínimo de 2 por cada 100 encomendas para cada variante de meias e sleeves. A aba Inventário tem o campo "Mínimo de sleeves por variante".
**Clubes no plano de stock (23 Set):** previsão por clube e por mês até 31 Jan (editável na aba Inventário): 10 meias da cor do clube + 10 brancas + 10 pretas (todas Kids), caneleiras Built-In Candal 2, Canidelo 2, Rio Tinto 7 (S45/M40/L15), Mini 3–4, Airflow 1 (só Rio Tinto). No último mês cada clube vendeu ~5 meias da sua cor. Com os clubes, as **Grip Preto Kids** esgotam já a ~3–5 Out e as **Mini 8x5 Preto** a ~Nov: é preciso encomendar Mini à threebo.
