...
**Regra de decisão para a Black Week (definida a 23 Set):** o dono acredita que o ROAS vai subir com mais e melhores anúncios e com posts diários no feed. Em vez de assumir isso, **provar em outubro**. A meio de outubro, se o custo por encomenda (gasto ÷ todas as encomendas) com **€80-100/dia** estiver em **≤ €12**, os criativos estão ~20% melhores e compensa ir **full gas** na Black Week (lucro estimado ~€27k contra ~€22k). Se estiver em **~€16 ou mais**, ficar no otimista-realista. A meio caminho, usar um valor intermédio (~€450-500/dia na Black Week).
