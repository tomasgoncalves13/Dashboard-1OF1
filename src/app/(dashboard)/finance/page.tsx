    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className={`text-2xl font-semibold ${breakdown.onlineNetProfit >= 0 ? "text-emerald-600" : "text-destructive"}`}>
              {formatMoney(breakdown.onlineNetProfit, currency)}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
              vs vendas site {formatMoney(breakdown.onlinePaidOrdersRevenue, currency)}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-xl font-semibold text-emerald-600">{formatMoney(breakdown.onlinePaidOrdersRevenue, currency)}</div>
