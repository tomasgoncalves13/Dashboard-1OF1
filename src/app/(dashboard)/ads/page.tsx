...
export default async function AdsPage({
  ...
  // como a média dos custos médios diários (cada dia pesa o mesmo), dentro do
  // intervalo de datas selecionado nos anúncios — se um dia mostrar 0 é
  // porque ainda não há encomendas Shopify sincronizadas para esse dia.
